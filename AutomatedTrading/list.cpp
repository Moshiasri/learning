...
using namespace std;		//Must use this to include STL!
...
int main ()
{
	...
	// We iterate over the elements of list 3 and print its elemets
	// Create list iterator
	list<double>::const_iterators i;
	...
	cout << endl;
	//Now populate a new list with the elements of list2
	list<double>list4;
	for (i = list2.begin(); i != list4.end(); ++i)
	{
		list4.push_back (*i);
	}
	//Print every character in the list
